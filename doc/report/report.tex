...
% Setup page geometry
\geometry{letterpaper, left=3cm, right=4cm, top=2.7cm, bottom=3.7cm}
\linespread{1.03}
...
%\setsansfont[Mapping=tex-text, BoldFont={Linux Libertine Bold}]{Linux Libertine}
\setmathfont[range=\mathit/{greek}]{Linux Libertine Italic}
...
\titleformat{\section}
{\huge\mdseries\sffamily\color{blue}}{\thesection}{0.5em}{}[{}]%\titlerule[0.6pt]}]
\titlespacing*{\section}{0pt}{1.3\baselineskip}{2.5\baselineskip}

\renewcommand{\cftsecfont}{\bfseries\rmfamily} 

\addtokomafont{section}{\Huge\mdseries\scshape\sffamily}%\rmfamily}
\addtokomafont{subsection}{\Large\mdseries\sffamily\color{blue}}
\addtokomafont{subsubsection}{\large\mdseries\sffamily\color{blue}}
